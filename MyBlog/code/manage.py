...
def deploy(deploy_type):
    ...
    def reset():
        classes = [BlogInfo,ArticleTypeSetting,ArticleType,Source,Plugin,BlogView,Menu,User]

        for a_class in classes:
            for each in a_class.query.all():
    ...
    if deploy_type == 'product':
        ...
        User.insert_admin(email='gzzmh@163.com', username='aaa', password='bbb')
    ...
    if deploy_type == 'test_data':
        ...
        Comment.generate_fake_replies(50)
