...
class CustomBlogInfoForm(Form):
    ...
    fileupload = FileField(u'上传博客背景图',validators=[FileAllowed(['jpg','png'],"仅支持jpg以及png格式的图片")])
...
class ImportFileForm(Form):
    fileupload = FileField(u'上传备份文件',validators=[FileAllowed(['json'],"请上传后缀名为json的文件")])
